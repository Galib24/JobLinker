                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p
                                            ...
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" /> $400 - $449 / month
                                        </p>
                                    </div>
                                    <div
                                        className="flex px-6 pb-3">
                                        ...
                                        <p
                                            className="font-semibold px-4 text-sm text-gray-500 flex items-center justify-center">
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" />$450 - $499 / month
                                        </p>
                                    </div>
                                    <div
                                        className="flex px-6 pb-3">
                                        ...
                                        <p
                                            className="font-semibold px-4 text-sm text-gray-500 flex items-center justify-center">
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" /> $500 - $549 / month
                                        </p>
                                    </div>
                                    <div
                                        className="flex px-6 pb-3">
                                        ...
                                        <p
                                            className="font-semibold px-4 text-sm text-gray-500 flex items-center justify-center">
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" />$550 - $599 / month
                                        </p>
                                    </div>
                                    <div
                                        className="flex px-6 pb-3">
                                        ...
                                        <p
                                            className="font-semibold px-4 text-sm text-gray-500 flex items-center justify-center">
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" />$600 - $649 / month
                                        </p>
                                    </div>
                                    <div
                                        ...
                                        <p
                                            className="font-semibold px-4 text-sm text-gray-500 flex items-center justify-center">
                                            <PiCurrencyCircleDollarDuotone className="text-xl mr-1" />$650 - $699 / month
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            {
                                featureJobData.map(item => <SingleFeaturedJobs
                                    key={item._id}
                                    item={item}>
                                </SingleFeaturedJobs>)
                            }
