...
import { BsFillCalendarDateFill, BsFillChatQuoteFill, BsInfoCircleFill } from "react-icons/bs";
...
const Dashboard = () => {
    return (
        <div>
            <div
                className="pt-24 bg-indigo-50 lg:mb-8 mb-4">
                <h2
                    className="text-2xl font-semibold text-center">
                    Dashboard
                </h2>
                <p
                    className="text-center pb-8 font-semibold mt-1 text-gray-500">
                        ...
                        <div>
                            <div>
                                ...
                                <div
                                    ...
                                    <div
                                        className="grid grid-rows-4 text-sm font-semibold ms-5 my-3 text-gray-500">
                                        <div
                                        ...
                                        <div
                                            className="my-2 flex items-center">
                                            <AiOutlineMacCommand className="text-xl mr-2" />  Dashboard Menu Two
                                        </div>
                                        <div
                                            className="my-2 flex items-center">
                                            <BsFillCalendarDateFill className="text-xl mr-2" />  Dashboard Menu Three
                                        </div>
                                        <div
                                            className="my-2 flex items-center">
                                            <BsFillChatQuoteFill className="text-xl mr-2" />   Dashboard Menu Four
                                        </div>
                                    </div>
                                    <hr className="border border-gray-300 rounded-full mx-6 my-3 mb-6" />
                                    <div
                                        className="mt-3 mx-4 grid grid-rows-4 text-sm font-semibold ms-5 my-3 text-gray-500">
                                        <div
                                            className="my-2 flex items-center">
            ...
            <div
                ...
                <div
                    className="bg-indigo-50 rounded-md mx-4 pb-5 hidden lg:block">
                    <div
                        className="mt-8">
                        <h2
                            className="font-semibold text-center text-xl">
                ...
                <div
                    className="lg:col-span-2 col-span-4 bg-blue-400 mx-2 rounded-md text-white">
                    Dashboard Content
                </div>
            </div>
        </div>
