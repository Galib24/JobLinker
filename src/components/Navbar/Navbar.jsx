...
const Navbar = () => {
  ...
  return (
    <header className="container max-w-full fixed z-30 top-0 ">
      <nav className="w-full py-1 bg-blue-50">
        {/* Desktop part */}
          ...
          <div className="text-white hidden sm:flex">
            <ul className="hidden sm:flex text-black items-center">
              ...
              <li
                ...
                className={styles.navLinks}
              >
                <Link href="/employers" className="text-sm font-semibold">
                  Employers
                </Link>
              </li>
              <li
                ...
                className={styles.navLinks}
              >
                <Link href="/candidates" className="text-sm font-semibold">
                  Candidates
                </Link>
              </li>
              <li
              ...
              <li className="flex items-center space-x-5 text-[#F68519]ml-10">
                {user ? (
                  ...
                  <Link href="/login">
                    <h3 className="cursor-pointer ease-out duration-300 text-sm font-semibold flex items-center bg-[#40e1f9] text-white px-3 py-2 rounded-xl">
